 ...
 * @version 1.0
 */
public class ApplicantUI implements PasswordChanger{
    ...
    private void menuChoice(int choice) {
        switch (choice) {
            ...
            case 6 -> changePassword(currentApplicant);
            case 0 -> {
    ...
    private void applyForProject() {
        ...
        if (applicationController.hasBooked(currentApplicant.getID())) {
            System.out.println("You already have an booked a flat.");
            return;
        }
