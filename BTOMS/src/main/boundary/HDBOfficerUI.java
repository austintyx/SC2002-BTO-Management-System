 ...
 * @version 1.0
 */
public class HDBOfficerUI implements PasswordChange{
    ...
    public void displayMainMenu() {
        ...
        do {
            ...
            choice = ConsoleUtils.readIntWithValidation("Enter your choice: ", "Invalid input.", 0, 9);
    ...
    private void processMenuChoice(int choice) {
        switch (choice) {
            ...
            case 9 -> changePassword(currentOfficer, passwordController, userRepository);
            case 0 -> {
    ...
    private void generateFlatSelectionReceipt() {
        ...
        String applicantNRIC = ConsoleUtils.readNonEmptyString("Enter applicant's NRIC: ");
        ...
        String applicantName = "Applicant Name"; // Replace with actual lookup
        int applicantAge = 30; // Replace with actual lookup
        String maritalStatus = "Married"; // Replace with actual lookup
    ...
    private void applyForProject() {
        ...
        if (currentOfficer.getHandlingProjects() != null && currentOfficer.getRegistrationStatus() == null) {
