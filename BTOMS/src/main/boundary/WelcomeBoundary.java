        ...
        while (true) {
            ...
            if (user instanceof HDBManager manager) {
                HDBManagerUI managerUI = new HDBManagerUI(
                        manager, hdbManagerController, projectController, applicationController, enquiriesController, officerRegistrationController, userRepository, applicationRepository, passwordController);
                managerUI.displayMainMenu();
            } else if (user instanceof HDBOfficer officer) {
                HDBOfficerUI officerUI = new HDBOfficerUI(
                        officer, projectController, applicationController, enquiriesController, officerRegistrationController, hdbOfficerController, userRepository, projectRepository, passwordController);
                officerUI.displayMainMenu();
            } else if (user instanceof Applicant applicant) {
                ApplicantUI applicantUI = new ApplicantUI(
                        applicant, projectController, applicationController, enquiriesController, passwordController, userRepository);
